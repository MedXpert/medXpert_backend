...
def populate_hcfs(apps,schema_editor):
    ...
    with open(relative_file_path) as f:
        ...
        for row in rows:
            ...
            HealthCareFacility(
                ...
                GPSCoordinates = Point(coord[0], coord[1], srid=4326) if coord else None, #900...
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('api', '0010_rename_imagegallerylinks_healthcarefacility_imagegallarylinks_and_more'),
    ]

    operations = [
        migrations.RunPython(populate_hcfs)
    ]
